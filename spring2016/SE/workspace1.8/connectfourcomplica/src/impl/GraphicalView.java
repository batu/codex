...
public class GraphicalView extends Application{
    ...
    public GraphicalView() {
    	...
    	if(gameName == "complica"){
    		...
    		System.out.println("The given game is not implemented. Please give 'complica' or 'connectfour' as input.");
    	}
    ...
    public void fillColor(int row, int col, Color color){
		this.board[row][col].setFill(color);
    }
    ...
    public void start(Stage primaryStage) {    
        ...
        primaryStage.setTitle("game with VISUALS"); 
